...
mvn initialize -DidentifyChangesInApi.target-pull-request-number=$PULL_REQUEST_NUMBER -DidentifyChangeInApi.target-pull-request-head-id=PULL_REQUEST_COMMIT_ID -DidentifyChangesInApi.phase=initialize
